...
@media screen and (max-width: 1400px) {
  ...
  .z-fortune {
    padding: 15px 15px 60px 15px;background:rgba(255,255,255,0.2);
    border-top-right-radius: 12px;
    border-bottom-left-radius: 12px;
    border-bottom-right-radius: 12px;
    .z-fortune-title {
    ...
    .z-astro-ul {
      overflow:hidden;display: block;padding-top: 20px;
      .z-astro-li,.z-astro-link {
          overflow:hidden; float:left;overflow: hidden;display: block;height: 80px;;
      }
      .z-astro-li {
          margin-bottom: 20px;
      }
      ...
      .z-astro-content {
         padding-left: 10px;color:#fff;overflow: hidden;box-sizing: border-box;
          .z-astro-aries {
              font-size: 15px;
          }
          .z-comprehensive-fortune,.z-short-comment {
  ...
  .z-fortune-type-ul {
    display: block;height: 40px;overflow:hidden;border-top-left-radius: 12px;
    .z-fortune-type-li {
      float:left;height: 40px;line-height: 40px;padding: 0px 15px;
      margin-right: 5px;
      background:rgba(255,255,255,1);
      &:last-child {
        border-top-right-radius: 12px;;
