    ...
    <div class="astrolog-img-box">
        <h2 class="astrolog-title astrolog-title2">
            <span class="float-left">
                <el-icon class="z-icon"><Star /></el-icon><span class="z-title-span">星座财运</span>
            </span>
            <a :href="`${runtimeConfig.public.APP_URL}/allarticle?type=astroFinancial&name=星座财运`" class="float-right">更多>></a>
        </h2>
...
const result2 = await apis.getArticleList({
    keywords: 'astroFinancial',
    pageNum: 1,
    pageSize: 6
})
astroEmotions.value = result2.data.value.data.list
console.log(astroEmotions, '---astroEmotions')
</script>
...
.astrolog-img-box {
    ...
    .z-title-span,.z-icon {
        vertical-align: middle;margin-right: 10px;color: orange;
    }
    .z-announcement-list {
        display: block;
